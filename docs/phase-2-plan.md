...
Counsel review packet: [counsel-review-packet-2.12.md](./counsel-review-packet-2.12.md) (issued 2026-08-10). **Alpha-test interim council dispositions recorded 2026-08-10** — public summary [ADR 0007](./decisions/0007-alpha-test-interim-council-dispositions.md); server mirror: `src/lib/counsel/dispositions.ts`. These clearances are for the sole-builder → alpha-test window; lasting questions must ship in the post-alpha report.
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Data map and retention schedule | LQ10–11, OQ15 | cleared | Alpha-test: proposed retention postures may run to prove efficacy; must be able to reset all included alpha-test data — no users or topic discussion carry over | 2026-08-10 | Interim council (project owner acting as council until alpha test) | [ADR 0007](./decisions/0007-alpha-test-interim-council-dispositions.md) (return to [packet](./counsel-review-packet-2.12.md)) | Project owner / 2026-08-10 | 2.11, 2.12 |
| Statutory membership vs program participation | LQ3, OQ2 | cleared | Alpha-test: “member” OK if test purpose communicated at assent and continually; preferred synonym **delegate**; not permanent statutory membership | 2026-08-10 | Interim council (project owner acting as council until alpha test) | [ADR 0007](./decisions/0007-alpha-test-interim-council-dispositions.md) | Project owner / 2026-08-10 | 2.1, 2.4, 2.5, 2.8, 2.12 |
| Formation or fiscal sponsorship | LQ1–2 | cleared | Alpha-test: existing proposed-project / not-incorporated framing adequate; no new entity/tax claims | 2026-08-10 | Interim council (project owner acting as council until alpha test) | [ADR 0007](./decisions/0007-alpha-test-interim-council-dispositions.md) | Project owner / 2026-08-10 | 2.1–2.2, 2.12 |
| Account and council authority | LQ4–5, OQ1, OQ3 | cleared | Alpha-test: continual communication of test purpose/limits sufficient; formal council/board forms during the test | 2026-08-10 | Interim council (project owner acting as council until alpha test) | [ADR 0007](./decisions/0007-alpha-test-interim-council-dispositions.md) | Project owner / 2026-08-10 | 2.5, 2.8, 2.9, 2.12 |
| Electronic assent | LQ8–9 | cleared | Alpha-test: keep current electronic assent; metrics/engineering discretion may inform later auth strategy | 2026-08-10 | Interim council (project owner acting as council until alpha test) | [ADR 0007](./decisions/0007-alpha-test-interim-council-dispositions.md) | Project owner / 2026-08-10 | 2.6, 2.8, 2.12 |
| Eligibility and geography | LQ12–14 | cleared | Alpha-test: **no geographical eligibility requirements** until the test ends; keep eligibility open for travel/demo | 2026-08-10 | Interim council (project owner acting as council until alpha test) | [ADR 0007](./decisions/0007-alpha-test-interim-council-dispositions.md) | Project owner / 2026-08-10 | 2.7, 2.8, 2.12 |
| Political-opinion and verification-data handling | LQ10–11 | cleared | Alpha-test: existing identity vs opinion/pseudonym separation adequate for now | 2026-08-10 | Interim council (project owner acting as council until alpha test) | [ADR 0007](./decisions/0007-alpha-test-interim-council-dispositions.md) | Project owner / 2026-08-10 | 2.7, 2.9–2.12 |
...
Phase 2 readiness counsel gates and local Docker Compose PG16 gated E2E are recorded in [phase-2-handoff.md](./phase-2-handoff.md). Foundation tag `phase-2-foundation` follows interim council clearance ([ADR 0007](./decisions/0007-alpha-test-interim-council-dispositions.md)). Managed host / production email and post-alpha lasting questions remain open.

**Project-owner two-lane sequencing:** [ADR 0006](./decisions/0006-phase-3-two-lane-sequencing.md). Lane A — Phase 3 *synthetic/closed* engineering may proceed. Lane B — alpha-test invite-only foundation may proceed under §7 alpha-test scopes; resettable data and post-alpha report obligations still apply.
