...
**Date:** 2026-08-13  
**Related:** [alpha-reset-classification.md](../alpha-reset-classification.md), [alpha-reset-runbook.md](../alpha-reset-runbook.md), [ADR 0014](./0014-institutional-conversation-lifecycle.md), OQ29, activation gate `remote_alpha_reset_verified`
