...
/** POST — reject a validated/under_review report with a substantive reason. */
export async function POST(request: Request, context: RouteContext) {
  ...
  const { rejectReport } = await import("@/lib/public-input/reports/service");
  const result = await rejectReport(getGatedDb(), {
