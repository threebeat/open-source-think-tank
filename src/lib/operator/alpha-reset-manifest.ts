...
export const RESET_MANIFEST_VERSION = "v2.5.0";
 ...
 * Count must remain 62 until schema grows (assertManifestComplete).
 */
export const ALPHA_RESET_TABLES: readonly AlphaResetTableEntry[] = [
  ...
  { table: "chamber_roll_calls", class: "reset" },
  { table: "council_roll_calls", class: "reset" },
  { table: "chamber_verdict_versions", class: "reset" },
  { table: "council_recommendation_versions", class: "reset" },
  { table: "chamber_sessions", class: "reset" },
  { table: "council_sessions", class: "reset" },
] as const;
